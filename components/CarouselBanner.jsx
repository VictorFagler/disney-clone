        ...
        {movies?.map((movie) => (
          <div key={movie.id} className="flex-full min-w-0 relative">
            <Image
              ...
              height={1080}
            />
            <div className="hidden md:inline absolute mt-0 top-0 pt-40 xl:pt-52 left-0 lg:mt-40 bg-transparent z-20 h-full w-full bg-gradient-to-r from-gray-900/90 via-transparent to-transparent space-y-5 p-10 text-white">
              <h2 className="text-5xl font-bold max-w-xl z-99 text-white">
                {movie.title}
              </h2>
